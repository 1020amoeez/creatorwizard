                    ...
                    <div className="main-card">
                        ...
                        <div className="option-field wallletaddress-field">
                            ...
                            <div className="twice-elem">
                                <input value={account || address} onChange={(e) => setAddress(e.target.value)} style={{ paddingRight: "22px" }} type="text" placeholder='Your Wallet Address...' />
                                {account ? (
                        ...
                        <div className="option-field">
                            ...
                            <div className="twice-inputeye">
                                <input value={password} onChange={(e) => setPassword(e.target.value)} type={showPass} placeholder='Your password...' />
                                <svg
                                    onClick={() => {
                                        showPass === "password"
                                            ? setShowPass("text")
                        ...
                        <div className="password-must">
                            ...
                            <ul className={passwordError ? "invalid" : "valid"}>
                                <li className={password.length >= 8 ? "valid" : "invalid"}>Be at least 8 characters long</li>
                                <li className={/[A-Z]/.test(password) ? "valid" : "invalid"}>Have at least one uppercase letter</li>
                                <li className={/[a-z]/.test(password) ? "valid" : "invalid"}>Have at least one lowercase letter</li>
                                <li className={/\d/.test(password) ? "valid" : "invalid"}>Contain at least one digit</li>
                                <li className={/[!@#$%^&*]/.test(password) ? "valid" : "invalid"}>Contain at least one special character</li>
                            </ul>
                        </div>
                        <div className="option-field">
                            ...
                            <div className="twice-inputeye">
                                <input value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} type={showCon} placeholder='Confirm password...' />
                                <svg
                                    onClick={() => {
                                        showCon === "password"
                                            ? setShowCon("text")
                        ...
                        {confirmPasswordError && <p className="text-danger mb-5">{confirmPasswordError}</p>}
                        <button onClick={userRegister} className='btn-sign'>Sign Up</button>
            ...
            <Modal className='buymodal' show={show} onHide={handleClose} centered>
                ...
                <Modal.Body>
                    <div className="confirmemail-address">
                        ...
                        <p>To complete your signup and start your journey with us, please confirm your email address by clicking the link below:</p>
                    </div>
