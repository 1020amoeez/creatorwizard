                        ...
                        <div key={index} className="main-mint-div">
                            <div className="left-side">
                                ...
                                <div className="left-text">
                                    ...
                                    <p>
                                        {teamMember ? `${teamMember.durationDays || 0} days, ${teamMember.durationHours || 0} hours, ${teamMember.durationMins || 0} mins` : '0 days, 0 hours, 0 mins'}
                                    </p>
                            ...
                            <div className="right-side">
                                <a onClick={() => {
                                    setCurrId(index); setModalInputValues(teamMember); handleShow()
                                ...
                                {teamMembers != 0 ? <a onClick={() => handleDeleteTeamMember(teamMember?.id)} className='btn-delete'><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <Modal className='buymodal mint-stage-modal' show={show} onHide={handleClose} centered>
                ...
                <Modal.Body>
                    ...
                    <div className="buymodalbtns">
                        <button className="bluebtn" onClick={handleModalDoneClick}>Done</button>
                    </div>
