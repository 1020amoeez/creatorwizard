        ...
        <div className="custom-container">
              ...
              <Dropdown className="profiledropdown" align="end">
                <Dropdown.Toggle id="dropdown-basic">
                  <div className="profilemainbtn">
                    ...
                    <img
                      src="\assets\navbarassets\arrow-down-profile.svg"
                      alt="arrow"
                      className="arrow"
                    />
                  </div>
          ...
          <div className="customnavbarmbl d-none">
            ...
            <div className="mobileicons">
              <img
                onClick={handleShow2}
                src="\assets\navbarassets\search-normalmbl.svg"
                alt="searchimg"
                className="searchimgmbl"
              />
              {clickedbtn ? null : (
                <Dropdown className="profiledropdownmbl" align="center">
                  <Dropdown.Toggle id="dropdown-basic">
                    <img
                      src="\assets\navbarassets\user.svg"
                      alt="profileimgmbl"
                      className="profileimgmbl"
                    />
                  </Dropdown.Toggle>
