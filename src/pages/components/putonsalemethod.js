                        ...
                        <div className="selectmethodleft">
                            ...
                            {activeTab === 'link-1' && (
                                <>
                                    ...
                                    <input type="text" placeholder='Amount' className="pricesaleinput" />
                                    <div className="pricesaledata">
                                        ...
                                        <h6 className="percentagepara">2.5%
                                    ...
                                    <button className="bluebtn" onClick={handleShow}>Complete Listing</button>
                                </>
                            )}
                            {activeTab === 'link-2' && (
                                <>
                                    ...
                                    <div className="pricesaleinputmain">
                                        <input type="text" placeholder='Duration' className="pricesaleinput" />
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className='calendarimg'>
                                    ...
                                    <div className="bottom-cards">
                                        <div className="main-card">
                                            <div className="main-img">
                                                <img
                                                    src="/assets/dummy-imgs/allcards/l1.png"
                                                    alt="img"
