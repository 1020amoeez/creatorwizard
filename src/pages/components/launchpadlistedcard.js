                ...
                <div className="single-card" key={index}>
                  <div className="main-img">
                    ...
                    <button
                      onClick={() => {
                        handleShow();
                        ListedDetails(card?._id, accessToken);
                      }}
                      className="bluebtn"
                    >
                      View Details
                  ...
                  <div className="bottom-content">
                    ...
                    <div className="progress-div">
                      <div className="upper-text">
                        <h6>Total Minted</h6>
                        <p>
                          {(card?.minted / card?.totalSupply) * 100 || "0"}%
                          <span>
                      ...
                      <ProgressBar
                        now={(card?.minted / card?.totalSupply) * 100}
                      />
                    </div>
                    <div className="fundraise-text">
                      <h6>Total Funds Raised</h6>
                      <p>
                        {parseFloat(card?.minted || 0) *
                    ...
                    <div className="timer-div">
                      ...
                      {hasMintingEnded ? (
                        ...
                        <p className="upcoming text-warning">Upcoming</p>
                      )}
      ...
      <Modal show={show} onHide={handleClose} className="buymodal" centered>
        ...
        <Modal.Body>
          <div className="mainminted">
            <div className="upperminted">
              <h6 className="totalpara">Total Minted</h6>
              <p className="percentagepara">
                {(stagedata?.minted / stagedata?.totalSupply) * 100 || "0"}%
                <span className="numbergrey">
                  ({stagedata?.minted}/{stagedata?.totalSupply})
                </span>
              </p>
            </div>

            <ProgressBar
              now={(stagedata?.minted / stagedata?.totalSupply) * 100}
            />
            <div className="twice-elem">
              <p className="addres-text p-1">Royalties</p>
            </div>
            <div className="twice-elem">
              ...
              <button
                onClick={() => GetRoyality(stagedata?.[0]?.contractAddress)}
                className="btn-send"
              >
                Send
              </button>
              ...
              {stagedata?.mintStages?.length ? (
                stagedata?.mintStages?.map((stage, index) => {
                  const previousEndTime =
                    index > 0
                      ? stagedata?.mintStages[index - 1].mintStageTime
                      : stagedata?.mintStartTime;
                  return (
                    <div className="mintstages" key={index}>
                      <p className="stagehead">Mint Stage {index + 1}</p>
                      <div className="innermintstages">
                      ...
                      <div className="innermintstages">
                        <div className="left">
                          <p className="namepara">Start Date</p>
                          <h6 className="presalepara">
                            {previousEndTime.slice(0, 19)}
                          </h6>
                        </div>
                        <div className="right">
                          <p className="salepara">End Date</p>
                          <h6 className="corepara">
                            {stage?.mintStageTime.slice(0, 19)}
                          </h6>
                        </div>
                      </div>
