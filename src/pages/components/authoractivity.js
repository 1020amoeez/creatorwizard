                        ...
                        {activityData.map(item => (
                            <div className="single-item" key={item.id}>
                                <div className="profile">
                                    <img src={item.imgUrl} alt="img" className='img-fluid main-img-profile' />
                                    <img src={item.imgUrl} alt="img" className='img-fluid small-img-icon' />
                                </div>
                                <div className="right-content">
                                    <h5>{item.username}</h5>
                                    <h6>
                                        <span className='text-span-color'> {item.address} </span>
                                    </h6>
                                    <p>{item.timestamp}</p>
                                </div>
                            </div>
