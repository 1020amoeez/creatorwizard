          ...
          <div className="submit-section">
              ...
              <div className="profile-img">
                <img
                  ...
                  src={
                    ...
                    "assets/discovercollection/upload-img.png"
                  }
                  alt="img"
                  className="img-fluid"
                />
            ...
            <div className="basic-data">
              <div className="twice-field-text">
                ...
                <div className="single-text">
                  <p>Launchpad</p>
                  {formDataname?.limitedEddition && <h6>Limited Edition</h6>}
                  {formDataname?.openEddition && <h6>Open Edition</h6>}
                </div>
              </div>
              <div className="single-text">
            ...
            <div
              className="team-info mint-info"
              style={{ border: "none", padding: "0", paddingTop: "30px" }}
            >
              <h5>Mint info</h5>
              <div className="single-text">
                <p>Mint Start Date</p>
