        ...
        <div className="stepcontainerdetail">
          ...
          <div className="stepinputmain">
            ...
            <input
              ...
              onChange={(e) =>
                setFormDataName({ ...formDataname, name: e.target.value })
              }
              type="text"
              className="stepinput"
          ...
          <div className="stepinputmain">
            ...
            <input
              value={formDataname?.symbol}
              onChange={(e) =>
                setFormDataName({ ...formDataname, symbol: e.target.value })
              }
              type="text"
              className="stepinput"
              placeholder="Launchpad Symbol"
            />
          </div>
          <div className="stepinputmain">
            <p className="stepinputpara">Launchpad Description</p>
            <textarea
              value={formDataname?.description}
              onChange={(e) =>
                setFormDataName({
                  ...formDataname,
          ...
          <div className="featuredmain">
            ...
            <div className="featuredmain">
              ...
              <p className="featurepara">
                ...
                homepage, category pages, or other display areas of Wizard.
              </p>
              {formDataname?.featureImageUrl ? (
                <div className="featuremainimg">
                  <img
                    src={formDataname.featureImageUrl}
                    alt="Uploaded feature image"
                    className="featureinnerimg"
                  />
                </div>
              ) : (
                <div
                  className="featureuploaddiv"
                ...
                >
                  <div className="fetureuploadinnerdiv">
                    ...
                    >
                      <path
                        d="M22.5 16.0791H7.5C6.9875 16.0791 6.5625 15.6541 6.5625 15.1416C6.5625 14.6291 6.9875 14.2041 7.5 14.2041H22.5C23.0125 14.2041 23.4375 14.6291 23.4375 15.1416C23.4375 15.6541 23.0125 16.0791 22.5 16.0791Z"
                        fill="white"
                      />
                      <path
                        d="M15 23.5791C14.4875 23.5791 14.0625 23.1541 14.0625 22.6416V7.6416C14.0625 7.1291 14.4875 6.7041 15 6.7041C15.5125 6.7041 15.9375 7.1291 15.9375 7.6416V22.6416C15.9375 23.1541 15.5125 23.5791 15 23.5791Z"
                        fill="white"
                      />
                    </svg>
                  </div>
          ...
          <div className="editions-div">
            <div
              ...
              className={`inner-edition ${
                activeEdition === "limited" ? "active" : ""
              }`}
            >
              <h6>Limited edition</h6>
              <p>A limited number of items</p>
          ...
          <div className="stepinputmain">
            ...
            <input
              value={formDataname?.websiteUrl}
              onChange={(e) =>
                setFormDataName({ ...formDataname, websiteUrl: e.target.value })
              }
              type="text"
              className="stepinput"
          ...
          <div className="stepinputmain">
            ...
            <input
              value={formDataname?.discordUrl}
              onChange={(e) =>
                setFormDataName({ ...formDataname, discordUrl: e.target.value })
              }
              type="text"
              className="stepinput"
              placeholder="Discord"
          ...
          <div className="stepinputmain">
            ...
            <input
              value={formDataname?.twitterUrl}
              onChange={(e) =>
                setFormDataName({ ...formDataname, twitterUrl: e.target.value })
              }
              type="text"
              className="stepinput"
              placeholder="Twitter"
