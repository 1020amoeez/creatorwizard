      ...
      <section className="stepmain">
        <div className="stepcontainerdetail">
          ...
          <p className="collectionpara">
            ...
            marketplace page on wizard marketplace
          </p>
                ...
                <label htmlFor="upload">
                  <div className="upload">
                    {createcollection?.featureImageUrl ? (
                      ...
                      >
                        <path
                          d="M22.5 16.4639H7.5C6.9875 16.4639 6.5625 16.0389 6.5625 15.5264C6.5625 15.0139 6.9875 14.5889 7.5 14.5889H22.5C23.0125 14.5889 23.4375 15.0139 23.4375 15.5264C23.4375 16.0389 23.0125 16.4639 22.5 16.4639Z"
                          fill="white"
                        />
                        <path
                          d="M15 23.9639C14.4875 23.9639 14.0625 23.5389 14.0625 23.0264V8.02637C14.0625 7.51387 14.4875 7.08887 15 7.08887C15.5125 7.08887 15.9375 7.51387 15.9375 8.02637V23.0264C15.9375 23.5389 15.5125 23.9639 15 23.9639Z"
                          fill="white"
                        />
                      </svg>
                    )}
          ...
          <div className="socialweblinks">
            ...
            <div className="stepinputmain marginmain">
              ...
              <input
                value={createcollection?.twitterUrl}
                onChange={(e) =>
                  setCreateCollection({
                    ...createcollection,
            ...
            <div className="stepinputmain marginmain">
              ...
              <input
                value={createcollection?.discordUrl}
                onChange={(e) =>
                  setCreateCollection({
                    ...createcollection,
            ...
            <div className="stepinputmain marginmain">
              ...
              <input
                value={createcollection?.websiteUrl}
                onChange={(e) =>
                  setCreateCollection({
                    ...createcollection,
