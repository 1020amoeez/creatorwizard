...
const CreateNewCollections = () => {
    ...
    const renderContent = () => {
        switch (currentCollection) {
            case 1:
                return <><Stepcollection onNext={handleNextStep} createcollection={createcollection} setCreateCollection={setCreateCollection} /></>;
            case 2:
                return <><Stepdetail onNext={handleNextStep} createcollection={createcollection} setCreateCollection={setCreateCollection} /></>;
            case 3:
                return <><StepMint onNext={handleNextStep} createcollection={createcollection} setCreateCollection={setCreateCollection} /></>;
            case 4:
                return <><Stepsubmit createcollection={createcollection} setCreateCollection={setCreateCollection} CreateCollection={CreateCollection} /></>;
            default:
                return null;
        }
    };
                    ...
                    <div className='createparent'>
                        <div className='left'>
                            ...
                            <div className='leftcard'>
                                ...
                                <ul>
                                    {['Collection Info', 'Listing details', 'Mint info', 'Submit'].map((tab, index) => (
                                        <li key={index}>
                                            <a
