    ...
    <>
                        ...
                        {justlanding.length > 0 ? (
                          justlanding.map((item, index) => (
                            <Link
                              ...
                              href={`/createlaunchpadcollection?id=${(accessToken, item?._id)
                                }`}
                              key={index}
                            >
      ...
      <Modal className="buymodal" show={show} onHide={handleClose} centered>
        ...
        <Modal.Body>
          ...
          <label htmlFor="uploadmedia" style={{ width: "100%", height: "100%" }}>
            <div className="select-media">
              <svg style={{ width: "80px", height: "80px" }} xmlns="http://www.w3.org/2000/svg" width="31" height="32" viewBox="0 0 31 32" fill="none">
          ...
          <button className="btn-save-submit" style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }} onClick={handleImageChange}>
            Upload images
          </button>
          <label style={{ width: "100%", height: "100%" }} htmlFor="uploadmetadata">
            <div className="select-media">
              <svg style={{ width: "50px", height: "50px" }} xmlns="http://www.w3.org/2000/svg" width="31" height="32" viewBox="0 0 31 32" fill="none">
          ...
          <button className="btn-save-submit" onClick={handleMetaChange} style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "25px" }}>
            Upload metadata
          </button>
          {/* <div>
            <input
          ...
          <div className="twice-btn">
            ...
            <a
              ...
              className={`btn-save ${(!imagesUploaded || !metadataUploaded) && "disabled"
                }`}
              style={{
