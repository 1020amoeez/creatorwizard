  ...
  return (
    <>
        ...
        <div className="custom-container">
          <div className="customnavbar">
            ...
            <div className="mid-links">
              <Link
                className={
                  router.pathname === "/components/collectiondashbord"
                    ? "active"
                    : ""
                }
                href="/collectiondashbord"
              >
                Launchpads
              </Link>
              <Link
                href="/mycollection"
                className={
                  router.pathname === "/components/mycollection" ? "active" : ""
                }
              >
                Collections
              </Link>
                  ...
                  <Dropdown.Toggle id="dropdown-basic">
                    <div className="profilemainbtn">
                      <div className="profilemainimg">
                        <img
                          src={
                            profile?.profileImageUrl || "/assets/profile.png"
                          }
                          alt="profileinnerimg"
                          className="profileinnerimg"
                        />
                      </div>
                  ...
                  <Dropdown.Menu>
                    ...
                    <div className="balancemain">
                      <div className="balanceimg">
                        ...
                        <img
                          src="\assets\launchpaddetailassets\clogo.svg"
                          alt="balanceinnerimg"
                          className="balanceinnerimg"
                        />
                      </div>
                    ...
                    >
                      ...
                      <Link href="/editprofile" className="profiledatapara">
                        Edit Profile
                      </Link>
          ...
          <div className="customnavbarmbl d-none">
            ...
            <div className="mobileicons">
              ...
              <img
                onClick={handleShow1}
                src="\assets\navbarassets\toggler.svg"
                alt="togglermbl"
                className="togglermbl"
              />
            </div>
          </div>
        </div>
      ...
      <Offcanvas
        ...
        onHide={handleClose}
        placement="end"
        className="connectwalletsidebar"
      >
        <Offcanvas.Body>
          <img
            src="\assets\navbarassets\closeimg.svg"
            alt="closeimg"
            className="closeimg"
            onClick={handleClose}
          />
          <h6 className="connectsidehead">Connect Wallet</h6>
          <p className="connectsidepara">
            By connecting your wallet, you agree to our{" "}
            <span className="bold">Terms of Service</span> and Our{" "}
        ...
        <Offcanvas.Body>
          <div className="mblnavlinks">
            ...
            <Link
              href="/mycollection"
              className={
                router.pathname === "/components/mycollection"
                  ? "dropitemmbl active"
                  : "dropitemmbl"
              }
            >
      ...
      <Offcanvas
        ...
        onHide={handleClose2}
        placement="end"
        className="searchnavside"
      >
        <Offcanvas.Body>
          <div className="searchlowermbl">
            <Dropdown
              show={searchText.trim() !== ""}
              className="dropdownsearchmbl"
            >
                    ...
                    <div className="collectionresult">
                      <div className="collectionresultleft">
                        <div className="collectionimg">
                          <img
                            src="\assets\navbarassets\collectioncardone.png"
                            alt="innercollectionimg"
                            className="innercollectionimg"
                          />
                        </div>
                        <div className="collectiontexts">
                          <h6 className="innercollectionhead">
                            Kups by Raposa
                          </h6>
                          <p className="innercollectionpara">
                            <img
                              src="\assets\navbarassets\itemimg.svg"
                              alt="inneritemimg"
                              className="inneritemimg"
                            />{" "}
                            10,000 items
                          </p>
                        </div>
                  ...
                  <Link href="/collections" onClick={handleClose2}>
                    <div className="collectionresult">
                      <div className="collectionresultleft">
                        <div className="collectionimg">
                          <img
                            src="\assets\navbarassets\collectioncardtwo.png"
                            alt="innercollectionimg"
                            className="innercollectionimg"
                          />
                        </div>
                  ...
                  <Link href="/collections" onClick={handleClose2}>
                    <div className="collectionresult">
                      <div className="collectionresultleft">
                        <div className="collectionimg">
                          <img
                            src="\assets\navbarassets\collectioncardthree.png"
                            alt="innercollectionimg"
                            className="innercollectionimg"
                          />
                        </div>
                  ...
                  <div className="accountmain">
                    ...
                    <Link href="/authorprofile" onClick={handleClose2}>
                      <div className="accountinner">
                        <div className="accoutnimg">
                          <img
                            src="\assets\navbarassets\accountcardone.png"
                            alt="accountinnerimg"
                            className="accountinnerimg"
                          />
                        </div>
                    ...
                    <Link href="/authorprofile" onClick={handleClose2}>
                      <div className="accountinner">
                        <div className="accoutnimg">
                          <img
                            src="\assets\navbarassets\accountcardtwo.png"
                            alt="accountinnerimg"
                            className="accountinnerimg"
                          />
                        </div>
                    ...
                    <Link href="/authorprofile" onClick={handleClose2}>
                      <div className="accountinner">
                        <div className="accoutnimg">
                          <img
                            src="\assets\navbarassets\accountcardthree.png"
                            alt="accountinnerimg"
                            className="accountinnerimg"
                          />
                        </div>
